...
class Tenant(models.Model):
    ...
    class Meta:
        ...
        # Unique constraint: one tenant name per shopping center
        # EXCEPT for "Vacant" - allow multiple vacant units per center
        constraints = [
            models.UniqueConstraint(
                fields=['shopping_center', 'tenant_name'],
                condition=~models.Q(tenant_name='Vacant'),
